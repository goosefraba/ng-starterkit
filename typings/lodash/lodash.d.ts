...
declare module _ {
    ...
    interface LoDashStatic {
         ...
         * @see _.zipObject
         */
        object<TValues, TResult extends {}>(props:List<StringRepresentable>,
                                            values?:List<TValues>): TResult;

        /**
         * @see _.zipObject
         */
        object<TResult extends {}>(props:List<StringRepresentable>,
                                   values?:List<any>): TResult;

        /**
         * @see _.zipObject
         */
        object(props:List<StringRepresentable>,
    ...
    interface LoDashStatic {
         ...
         */
        zipObject<TValues, TResult extends {}>(props:List<StringRepresentable>,
                                               values?:List<TValues>): TResult;

        /**
         * @see _.zipObject
         */
        zipObject<TResult extends {}>(props:List<StringRepresentable>,
                                      values?:List<any>): TResult;

        /**
         * @see _.zipObject
         */
        zipObject(props:List<StringRepresentable>,
                  values?:List<any>): _.Dictionary<any>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @param pluckValue _.pluck style callback
         **/
        filter(pluckValue:string): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.filter
         * @param pluckValue _.pluck style callback
         **/
        filter<W>(whereValue:W): LoDashImplicitArrayWrapper<T>;
         ...
         * @param pluckValue _.pluck style callback
         **/
        select(pluckValue:string): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.filter
         * @param pluckValue _.pluck style callback
         **/
        select<W>(whereValue:W): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @see _.pluck
         **/
        pluck<TResult>(property:string): LoDashImplicitArrayWrapper<TResult>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
        ...
        set(path:StringRepresentable|StringRepresentable[],
            value:any): LoDashImplicitObjectWrapper<T>;
    }
